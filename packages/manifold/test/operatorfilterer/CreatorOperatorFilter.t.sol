...
contract OperatorFilterTest is Test {
  ...
  function testAccess() public {
    ...
    example.configureBlockedOperators(address(creatorCore721), new address[](0), new bool[](0));

    vm.expectRevert("Wallet is not an admin");
    example.configureBlockedOperatorHashes(address(creatorCore721), new bytes32[](0), new bool[](0));
  ...
  function testShouldBlockFilteredOperators721() public {
    ...
    example.configureBlockedOperators(address(creatorCore721), blockedOperators, blockedOperatorsValues);
  ...
  function testBlockFilteredOperators() public {
    ...
    example.configureBlockedOperators(address(creatorCore1155), blockedOperators, blockedOperatorsValues);
    vm.stopPrank();
    vm.startPrank(operator);
    vm.expectRevert();
    creatorCore1155.safeTransferFrom(owner, operator2, 1, 1, "0x0");
