...
contract ERC1155LazyPayableClaimSignatureMintingV2Test is Test {
    ...
    function testSignatureMint() public {
      ...
      vm.expectRevert(ILazyPayableClaimV2.InvalidSignature.selector);
      example.mintSignature{value: mintFee*3}(
        address(creatorCore),
        1,
        mintCount,
      ...
      (v, r, s) = vm.sign(privateKey, message);
      signature = abi.encodePacked(r, s, v);
      vm.expectRevert(ILazyPayableClaimV2.ExpiredSignature.selector);
      example.mintSignature{value: mintFee*3}(
        address(creatorCore),
        1,
        mintCount,
      ...
      vm.expectRevert(ILazyPayableClaimV2.MustUseSignatureMinting.selector);
