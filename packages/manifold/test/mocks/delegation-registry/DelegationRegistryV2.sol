...
import {IDelegationRegistryV2} from "../../../contracts/libraries/delegation-registry/IDelegationRegistryV2.sol";
import {RegistryHashes as Hashes} from "./libs/RegistryHashes.sol";
import {RegistryStorage as Storage} from "./libs/RegistryStorage.sol";
import {RegistryOps as Ops} from "./libs/RegistryOps.sol";
 ...
 */
contract DelegationRegistryV2 is IDelegationRegistryV2 {
    ...
    /// @inheritdoc IDelegationRegistryV2
    ...
    function supportsInterface(bytes4 interfaceId) external pure returns (bool) {
        return Ops.or(interfaceId == type(IDelegationRegistryV2).interfaceId, interfaceId == 0x01ffc9a7);
    }
