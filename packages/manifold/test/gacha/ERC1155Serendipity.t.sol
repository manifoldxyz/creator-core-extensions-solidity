...
contract ERC1155SerendipityTest is Test {
  ...
  function test_UpdateClaim_LimitedSupplySanitization() public {
    ...
    example.mintReserve{ value: 1 + MINT_FEE }(address(creatorCore1), 1, 1, new uint32[](0), new bytes32[][](0), address(0));
  ...
  function test_UpdateClaim_ChangeSupplyForLimitedInitialSupply() public {
    ...
    example.initializeClaim(address(creatorCore1), 1, claimP);
    example.mintReserve{ value: 5 + 5*MINT_FEE }(address(creatorCore1), 1, 5, new uint32[](0), new bytes32[][](0), address(0));
  ...
  function testMintReserveLowPayment() public {
    ...
    example.mintReserve{ value: 1 }(address(creatorCore1), 1, 2, new uint32[](0), new bytes32[][](0), address(0));
  ...
  function testMintReserveEarly() public {
    ...
    example.mintReserve{ value: 3 }(address(creatorCore1), 1, 1, new uint32[](0), new bytes32[][](0), address(0));
    vm.stopPrank();
  }
  ...
  function testMintReserveNone() public {
    ...
    example.mintReserve{ value: 1 + MINT_FEE }(address(creatorCore1), 1, 0, new uint32[](0), new bytes32[][](0), address(0));
    vm.stopPrank();
  }
  ...
  function testMintReserveMoreThanAvailable() public {
    ...
    example.initializeClaim(address(creatorCore1), 1, claimP);
    example.mintReserve{ value: mintPrice + MINT_FEE }(address(creatorCore1), 1, 1, new uint32[](0), new bytes32[][](0), address(0));
    ...
    example.mintReserve{ value: (mintPrice + MINT_FEE) * 5 }(address(creatorCore1), 1, 5, new uint32[](0), new bytes32[][](0), address(0));
    vm.stopPrank();
  ...
  function testDeliverMints() public {
    ...
    example.initializeClaim(address(creatorCore1), 1, claimP);
    example.mintReserve{ value: (1 + MINT_FEE) * 2 }(address(creatorCore1), 1, 2, new uint32[](0), new bytes32[][](0), address(0));
    vm.stopPrank();

    vm.startPrank(other2);
    example.mintReserve{ value: (1 + MINT_FEE) * 4 }(address(creatorCore1), 1, 4, new uint32[](0), new bytes32[][](0), address(0));
    vm.stopPrank();
  ...
  function testTokenURI() public {
    ...
    example.initializeClaim(address(creatorCore1), 1, claimP);
    example.mintReserve{ value: totalMintPrice }(address(creatorCore1), 1, 1, new uint32[](0), new bytes32[][](0), address(0));
    ...
    vm.startPrank(other);
    example.mintReserve{ value: totalMintPrice * 2 }(address(creatorCore1), 1, 2, new uint32[](0), new bytes32[][](0), address(0));
    vm.stopPrank();
    vm.startPrank(other2);
    example.mintReserve{ value: totalMintPrice }(address(creatorCore1), 1, 1, new uint32[](0), new bytes32[][](0), address(0));
    vm.stopPrank();
