...
import "../contracts/metadata/ERC721FrozenMetadataNoFilterer.sol";
...
contract ERC721FrozenMetadataTest is Test {
    ...
    function testTransferRestriction() public {
      ...
      CreatorOperatorFilterer filterer = new CreatorOperatorFilterer();
      creatorCore.setApproveTransfer(address(filterer));
      ...
      blocked[0] = true;
      filterer.configureBlockedOperators(address(creatorCore), blockedAddresses, blocked);

      creatorCore.transferFrom(owner, other2, 1);
      vm.stopPrank();
    }
}