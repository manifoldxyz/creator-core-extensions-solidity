...
/**
    ...
    2. Run the script, like `forge script scripts/ERC1155GachaLazyClaim.s.sol --rpc-url https://eth-sepolia.g.alchemy.com/v2/xxx --broadcast`
...
contract DeployERC1155GachaLazyClaim is Script {
    function run() external {
        ...
        // forge script scripts/ERC1155GachaLazyClaim.s.sol --optimizer-runs 1000 --rpc-url <YOUR_NODE> --broadcast
