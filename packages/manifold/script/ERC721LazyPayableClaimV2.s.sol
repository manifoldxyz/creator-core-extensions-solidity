...
/**
    Deploy the ERC721LazyPayableClaimV2 contract.
    The ERC721LazyPayableClaimV2 contract is an alternative version to the ERC721LazyPayableClaim contract, with the difference being mintFee and mintMerkleFee are now updatable.
    ...
    2. Run the script, like `forge script scripts/ERC721LazyPayableClaimV2.s.sol --rpc-url https://eth-goerli.g.alchemy.com/v2/xxx --broadcast`
 ...
 */
contract DeployERC721LazyPayableClaimV2 is Script {
  ...
  function run() external {
    ...
    // forge verify-contract --compiler-version 0.8.17 --optimizer-runs 500 --chain goerli <DEPLOYED_ADDRESS> contracts/lazyclaim/ERC721LazyPayableClaimV2.sol:ERC721LazyPayableClaimV2 --constructor-args $(cast abi-encode "constructor(address,address,address)" "${INITIAL_OWNER}" "0x00000000000076A84feF008CDAbe6409d2FE638B" "0x00000000000000447e69651d841bD8D104Bed493") --watch
    new ERC721LazyPayableClaimV2{ salt: 0x4552433732314c617a7950617961626c65436c61696d4552433732314c617a79 }(
      initialOwner,
      DELEGATION_REGISTRY,
