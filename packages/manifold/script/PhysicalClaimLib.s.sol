...
contract DeployPhysicalClaimLib is Script {
    function run() external {
        ...
        // e.g.
        //   forge script scripts/PhysicalClaimLib.s.sol --optimizer-runs 150 --rpc-url <YOUR_NODE> --broadcast
        //   forge verify-contract --compiler-version 0.8.17 --optimizer-runs 150 --chain goerli <DEPLOYED_ADDRESS> contracts/physicalclaim/PhysicalClaimLib.sol:PhysicalClaimLib --watch
