 ...
 *     2. Run the script, like `forge script scripts/ERC1155SerendipityUSDC.s.sol --rpc-url https://eth-goerli.g.alchemy.com/v2/xxx --broadcast`
 ...
 */
contract DeployERC1155SerendipityUSDC is Script {
    function run() external {
        ...
        // forge script script/ERC1155SerendipityUSDC.s.sol --optimizer-runs 500 --rpc-url <YOUR_NODE> --broadcast
        // forge verify-contract --compiler-version 0.8.17 --optimizer-runs 500 --chain sepolia <DEPLOYED_ADDRESS> contracts/gachaclaims/ERC1155SerendipityUSDC.sol:ERC1155SerendipityUSDC --constructor-args $(cast abi-encode "constructor(address,address,uint256)" "${INITIAL_OWNER}" "${USDC_ADDRESS}" "${MINT_FEE}") --watch
        new ERC1155SerendipityUSDC{salt: 0x4552433131353553657265646e64697069747955534443000000000000000000}(
            initialOwner, usdcAddress, mintFee
        );
        vm.stopBroadcast();
    }
}
