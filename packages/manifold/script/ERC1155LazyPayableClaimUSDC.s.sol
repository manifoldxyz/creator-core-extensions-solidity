...
import "../contracts/lazyclaim/ERC1155LazyPayableClaimUSDC.sol";
 ...
 */
contract DeployERC1155LazyPayableClaimUSDC is Script {
    ...
    function run() external {
        ...
        // forge script script/ERC1155LazyPayableClaim.s.sol --optimizer-runs 500 --rpc-url <YOUR_NODE> --broadcast
        // forge verify-contract --compiler-version 0.8.17 --optimizer-runs 500 --chain goerli <DEPLOYED_ADDRESS> contracts/lazyclaim/ERC1155LazyPayableClaim.sol:ERC1155LazyPayableClaim --constructor-args $(cast abi-encode "constructor(address,address,address)" "${INITIAL_OWNER}" "0x00000000000076A84feF008CDAbe6409d2FE638B" "0x00000000000000447e69651d841bD8D104Bed493") --watch
        new ERC1155LazyPayableClaimUSDC{salt: 0x4552433732314c617a7950617961626c65436c61696d4552433732314c617a79}(
