...
/**
    ...
    2. Run the script, like `forge script scripts/FramePaymaster.s.sol --rpc-url https://eth-goerli.g.alchemy.com/v2/xxx --broadcast`
 ...
 */
 contract DeployFramePaymaster is Script {
    function run() external {
        ...
        // forge script scripts/FramePaymaster.s.sol --optimizer-runs 1000 --rpc-url <YOUR_NODE> --broadcast
        // forge verify-contract --compiler-version 0.8.17 --optimizer-runs 1000 --chain goerli <DEPLOYED_ADDRESS> contracts/frameclaims/FramePaymaster.sol:FramePaymaster --constructor-args $(cast abi-encode "constructor(address)" "${INITIAL_OWNER}") --watch
        new FramePaymaster{salt: 0x4672616d655061796d61737465724672616d655061796d61737465724672616d}(initialOwner);
        vm.stopBroadcast();
    }
}