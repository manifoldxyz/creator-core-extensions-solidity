...
import "../contracts/burnredeem/BurnRedeemLib.sol";
...
contract DeployBurnRedeemLib is Script {
    function run() external {
        ...
        // e.g.
        //   forge script script/BurnRedeemLib.s.sol:DeployBurnRedeemLib --optimizer-runs 150 --rpc-url <YOUR_NODE> --broadcast
