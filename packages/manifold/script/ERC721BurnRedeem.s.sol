...
contract DeployERC721BurnRedeem is Script {
    function run() external {
        ...
        // e.g.
        //   forge script script/ERC721BurnRedeem.s.sol:DeployERC721BurnRedeem --optimizer-runs 150 --rpc-url <YOUR_NODE> --libraries contracts/burnredeem/BurnRedeemLib.sol:BurnRedeemLib:<BURN_REDEEM_LIB_ADDRESS> --broadcast
