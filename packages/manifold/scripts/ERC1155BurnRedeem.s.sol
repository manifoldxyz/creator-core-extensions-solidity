...
contract DeployERC1155BurnRedeem is Script {
    function run() external {
        ...
        // e.g.
        //   forge script script/ERC1155BurnRedeem.s.sol --optimizer-runs 150 --rpc-url <YOUR_NODE> --libraries contracts/burnredeem/BurnRedeemLib.sol:BurnRedeemLib:<BURN_REDEEM_LIB_ADDRESS> --broadcast
