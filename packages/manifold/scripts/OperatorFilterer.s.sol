...
contract DeployOperatorFilterer is Script {
    ...
    function run() external {
        ...
        // forge verify-contract --compiler-version 0.8.17 --optimizer-runs 1000 --chain goerli <DEPLOYED_ADDRESS> contracts/operatorfilterer/OperatorFilterer.sol:OperatorFilterer --constructor-args $(cast abi-encode "constructor(address,address)" "${SUBSCRIPTION}" "0x000000000000AAeB6D7670E522A718067333cd4E") --watch
